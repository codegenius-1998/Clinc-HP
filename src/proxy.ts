 ...
 * a tunnel (cloudflared, ngrok, …). POST /api/uploads writes to Supabase Storage, which is fine on
 * localhost and not on a public URL.
 *
 ...
 * the owner-session checks still decide who may do what once past it.
 *
